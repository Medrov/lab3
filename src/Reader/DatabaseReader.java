...
public class DatabaseReader {
    public ArrayList<Database> readDB(ArrayList<Reactor> reactorTypes){
        Connection connection = connect();
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        ArrayList<Database> reactors = new ArrayList<>();
        try{
            String select = """
    ...
    private Connection connect(){
        ...
        String user = "postgres.cyebjhvlvxtajvergmkc";
        String password = "Lab4Admin!**";
        try {
